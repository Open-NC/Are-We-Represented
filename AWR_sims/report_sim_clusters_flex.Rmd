...
#
if (do_for_which=="POP"){
  df_county_to_pursue_0_pop <- df_county_to_pursue_0
  df_county_to_pursue_0_pop$for_which <- "POP"
  df_county_to_pursue_gt0_pop <- df_county_to_pursue_gt0
  df_county_to_pursue_gt0_pop$for_which <- "POP"
  save(
    df_county_to_pursue_0_pop,
    df_county_to_pursue_gt0_pop,
    file=paste0(output_dir,"df_county_to_pursue_",do_for_which,".RData")
  )
} 
#
if (do_for_which=="VOTE"){
  df_county_to_pursue_0_vote <- df_county_to_pursue_0
  df_county_to_pursue_0_vote$for_which <- "VOTE"
  df_county_to_pursue_gt0_vote <- df_county_to_pursue_gt0
  df_county_to_pursue_gt0_vote$for_which <- "VOTE"
  save(
    df_county_to_pursue_0_vote,
    df_county_to_pursue_gt0_vote,
    file=paste0(output_dir,"df_county_to_pursue_",do_for_which,".RData")
  )
}
```
